...
public class AuthenticationService {
    private final UserSECRepo repository;
    ...
    private void saveUserToken(UserSEC user, String jwtToken) {
    ...
    private void revokeAllUserTokens(UserSEC user) {
